...
you should place your code here."
  ;; Apply all-the-icons.el to neotree
  (setq neo-theme 'icons)
  ;; Indent Go code with 4 spaces
  (setq go-tab-width 4)
  )
